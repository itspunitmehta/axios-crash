...
function getTodos() {
  ...
  function cancelToken() {
    ...
    .catch((thrown)=>{
        if(axios.isCancel(thrown)){
            console.log("Request has beencancelled", thrown.message);
        }
    });
    // if(true){
  ...
  axiosInstance.get('/photos').then(res=>showOutput(res));
